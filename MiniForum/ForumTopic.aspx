          ...
          <ItemTemplate>
                ...
                <tr   style="  background:#F7F6F3; color:#333333"> 
                    <td  width=60% style="border: 0px; text-align:left; vertical-align: middle; padding:  1px 10px 3px 10px"> 
                        ...
                        Тема создана <%# DataBinder.Eval(Container.DataItem, "topicAddDate")%>,  
                        автор <asp:HyperLink ID="HyperLink1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "topicAutor")%>' NavigateUrl='<%#String.Format("~/Account/UserProfile.aspx?userid={0}", Eval("topicAutor"))%>' ForeColor="#3366CC" Font-Overline="false"/>
                        <br />
                        <br />
                    ...
                    <td width=20% style="border: 0px;  "> 
                        ...
                        от  <asp:HyperLink ID="hprlnkLastMessAutor" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "lastMessAutor")%>' NavigateUrl='<%#String.Format("~/Account/UserProfile.aspx?userid={0}", Eval("lastMessAutor"))%>' ForeColor="#3366CC" Font-Overline="false"/>
